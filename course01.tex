...
\begin{block}{}
  ...
  %find a decomposition of the vertices of a graph into subtrees of a tree
  %such that vertices are adjacent in the graph only when the corresponding subtrees intersect
\end{block}
\begin{center}
